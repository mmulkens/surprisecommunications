...
export default function YearFilter( {profileId, initialYear, initialResults} ) {
  ...
  return (
    <div className="w-72 my-6 bg-white/30 p-4 rounded-2xl text-center">
      <select 
        ...
        className="border-white px-2 py-1 mb-4 rounded-lg bg-white/30 text-red-100 focus:text-red-800 font-medium"
      >
        {years.map(y => (
